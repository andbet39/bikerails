...
class PointsControllerTest < ActionController::TestCase
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post :create, point: { elevation: @point.elevation, lat: @point.lat, lng: @point.lng, time: @point.time }
    end
  ...
  test "should update point" do
    patch :update, id: @point, point: { elevation: @point.elevation, lat: @point.lat, lng: @point.lng, time: @point.time }
    assert_redirected_to point_path(assigns(:point))
  end
